...
void loop()
{
  ...
  if(validSPO2 && validHeartRate) {
    display.print(F("Heart Rate: ")); display.println(heartRate -20, DEC); display.println(F(" bpm\n"));
    display.print(F("Blood Oxygen: ")); display.println(spo2, DEC); display.println(F(" %"));
  } else {
    display.println("   Not");
